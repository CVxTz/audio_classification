...
def get_model_mel():
    ...
    incep_res = NASNetMobile(input_shape=(157, 320, 1), weights=None, include_top=False)
...
model.fit_generator(train_generator(tr_files), steps_per_epoch=len(tr_files)//batch_size, epochs=100,
                   ...
                   use_multiprocessing=True, workers=8, max_queue_size=20,
                    callbacks=[ModelCheckpoint("nas.h5", monitor="val_acc", save_best_only=True),
